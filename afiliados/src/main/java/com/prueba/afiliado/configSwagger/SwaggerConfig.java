package com.prueba.afiliado.configSwagger;
...
public class SwaggerConfig {
    ...
    public Docket api() {
        return new Docket(DocumentationType.SWAGGER_2)
                .select()
                .apis(RequestHandlerSelectors.basePackage("com.prueba.afiliado.controller"))
    ...
    private ApiInfo apiEndPoinstInfo() {
        return new ApiInfoBuilder()
                .title("NttData Technical Test Java REST API")
